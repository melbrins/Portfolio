...
if( class_exists( 'TribeEvents' ) ) {
	...
	function tribe_events_the_previous_month_link() {
		...
		//$html = '<a class="btn red" data-month="'. $date .'" href="' . $url . '" rel="prev"><span>&lt;</span> '. $text .' </a>';
		$html = '<a class="btn red" data-month="'. $date .'" href="' . $url . '" rel="prev">Previous month</a>';
	...
	function tribe_events_the_next_month_link() {
		...
		try {
			...
			$html = '<a class="btn red" data-month="'. $date .'" href="' . $url . '" rel="next">Next month</a>';
