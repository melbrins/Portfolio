...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        <tr valign="top">
			<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner1') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner1') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
			...
			<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner2') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner2') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
	...
	<tr valign="top">
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner3') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner4') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
		...
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner4') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner4') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
	...
	<tr valign="top">
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner5') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner5') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
		...
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner6') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner6') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
	...
	<tr valign="top">
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner7') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner7') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
		...
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banne8') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner8') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
	...
	<tr valign="top">
		<td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner9') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner9') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
        ...
        <td style="width:200px;"><?php if ( get_option('buffercode_RBanner_text_banner10') ){ ?><img src="<?php echo get_option('buffercode_RBanner_text_banner10') ?>" alt="random banner image"  style="max-width:200px;"/><?php } ?></td>
