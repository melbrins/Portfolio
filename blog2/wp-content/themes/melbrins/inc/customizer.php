<?php
/**
 * Melbrins Customizer functionality
 *
 * @package WordPress
 * @subpackage Melbrins
 * @since Melbrins 1.0
...
function twentysixteen_custom_header_and_background() {
	...
	/**
	 * Filter the arguments used when adding 'custom-background' support in Melbrins.
	 *
	 * @since Melbrins 1.0
	 *
	 * @param array $args {
	...
	/**
	 * Filter the arguments used when adding 'custom-header' support in Melbrins.
	 *
	 * @since Melbrins 1.0
	 *
	 * @param array $args {
...
/**
 * Registers color schemes for Melbrins.
 *
...
function twentysixteen_get_color_schemes() {
	/**
	 * Filter the color schemes registered for use with Melbrins.
	 *
...
/**
 * Retrieves the current Melbrins color scheme.
 *
...
/**
 * Retrieves an array of color scheme choices registered for Melbrins.
 *
...
/**
 * Handles sanitization for Melbrins color schemes.
 *
