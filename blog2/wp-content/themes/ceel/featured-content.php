	...
	<div class="featured-content">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<header class="entry-header">
				<h2>
					<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'ceel' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php  echo short_title('...', 20); ?></a>
				</h2>
				<div class="rating">
					<div class="clearfix">
		...
		<div class="wrap">
			...
			<div class="main-post">
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<header class="entry-header">
						<h2><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'ceel' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php  echo short_title('...', 20); ?></a></h2>
					</header><!-- .entry-header -->
					<div class="rating">
						<div class="clearfix">
							<?php the_author_post_rating(); ?>
