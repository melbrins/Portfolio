			...
			?>
					...
					<div class="news <?php echo $array_slider[$get_class_name]?>">
						...
						<div class="desc">
							...
							<h2>
								<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'ceel' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php  echo short_title('...', 10); ?></a>
							</h2>
							<?php if ($get_class_name == 4){ ?>
									<?php echo string_limit_words(get_the_excerpt(),30)?>
									<a class="more" href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'ceel' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark">[Read more]</a>
							<?php } ?>
						</div>
					</div>
