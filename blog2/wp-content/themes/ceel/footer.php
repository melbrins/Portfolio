			...
			<div class="box-2 fl">
				<ul>
					...
					?>
							...
							<li><a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'ceel' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"><?php  echo short_title('...', 10); ?></a></li>
